...
<div class="body1">
    ...
    <h1>    </h1>
    <div class="klant">
        <h2>MagazijnMedewerker</h2>
    <ul>
        <li><a href="readartikel.php">read artikel</a></li>
        <li><a href="searchartikel.php">search artid </a></li>
        <li><a href="updateartikelFormulier1.php">update artikel</a></li>
        <li><a href="deleteklantFormulier1.php">update verkooporders</a></li>
    </ul>
    </div>
</div>
</body>
