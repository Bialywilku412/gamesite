...
<p>
    Dit formulier zoekt een order op.
</p>

<p>Welk order zoekt u?</p>


<div class="contact-section">
    <form class="contact-form" action="searchconsole2.php" method="post">
            <input type="text" class="contact-form-text" placeholder="verkOrdidvak" name="verkOrdidvak">
