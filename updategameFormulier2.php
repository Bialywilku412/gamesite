...
<body STYLE="background-color: #808080">
    <div class="h33">
        ...
        $artikel->searchartikel($gameid);
        // properties in variabelen zetten
        $gamenaam = $artikel->getgamenaam();
        $gameprijs = $artikel->getgameprijs();
        $gameplatform = $artikel->getgameplatform();
        ...
        <form class="contact-form" action="updategameFormulier3.php" method="post">
            ...
            <?php echo $gameid ?>
            <input type="hidden" class="contact-form-text" name="gameidvak" value="<?php echo $gameid; ?> "><br />
            <input type="text" class="contact-form-text" name="gamenaamvak" value="<?php echo $gamenaam; ?> "><br />
            <input type="text" class="contact-form-text" name="gameprijsvak"
                value="<?php echo $gameprijs; ?> "><br /><br />
            <input type="text" class="contact-form-text" name="gameplatformvak"
                value="<?php echo $gameplatform; ?> "><br /><br />
